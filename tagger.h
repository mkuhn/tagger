...
class Tagger
{
	...
	public:
		...
		void add_document_acronym(const char* name, const char* acronym);
	...
	private:
		void find_matches(Matches& matches, Tokens& tokens, char* document, const char* document_id, const GetMatchesParams& params, const unordered_set<int>& entity_types);
